...
namespace ApiEcommerce.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status403Forbidden)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public IActionResult GetProductsInPage ([FromQuery] int pageNumber = 1, int pageSize = 5)
        {
        ...
        public IActionResult CreateProduct([FromForm] CreateProductDto createProductDto)
        {
            ...
            {
                ModelState.AddModelError("CustomError", $"La categoria con el id {createProductDto.CategoryId} ya existe");
                return BadRequest(ModelState);
            }
        ...
        public IActionResult SearchProducts(string searchTerm)
        {
            ...
            if (products.Count == 0)
            {
                return NotFound($"Los productos con el nomnbre o descripcion '{searchTerm}' no existe");
            }
        ...
        public IActionResult DeleteProduct(int productId)
        {
            ...
            if (!_productRepository.DeletedProduct(product))
            {
