...
public class UserRepository : IUserRepository
{
    ...
    {
        return !_db.Users.Any(u => u.Name.Trim().ToLower() == name.Trim().ToLower());
    }
    ...
    public async Task<UserLoginResponseDto> Login(UserLoginDto userLoginDto)
    {
        ...
        var userName = userLoginDto.UserName.ToLower().Trim();
        var user = await _db.ApplicationUsers.FirstOrDefaultAsync<ApplicationUser>(
            u => u.UserName != null && u.UserName.ToLower().Trim() == userName);
